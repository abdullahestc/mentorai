...
const topics = [
    { title: "Bilgi Ve İnanç", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4.  Kaynak"] },
    { title: "İbadetler", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
    { title: "Ahlak Ve Değerler", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
    { title: "Hz. MUHAMMED (S.A.V.)", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
    { title: "Vahiy Ve Akıl", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
    { title: "İslam Düşüncesinde Yorumlar, Mezhepler", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
    { title: "Din, Kültür Ve Medeniyet", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
];

export function DinForm() {
            ...
            <Card className="w-full max-w-full mx-auto my-6">
                <CardContent className="flex flex-col gap-4 px-6 py-4">
                    <div className="flex items-center justify-between">
                        <h3 className="text-4xl font-semibold tracking-tight">DİN</h3>
