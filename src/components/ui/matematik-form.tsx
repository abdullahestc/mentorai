...
const topics = [
    { title: "Temel Kavramlar", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4.  Kaynak"] },
    { title: "Sayı Basamakları", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
    { title: "Bölme ve Bölünebilme", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
    { title: "Ebob-Ekok", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
    { title: "Rasonel Sayılar", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
    // ...
    { title: "İntegral", konuCalismasi: true, tekrarlar: ["1. Tekrar", "2. Tekrar", "3. Tekrar", "4. Tekrar"], kaynaklar: ["1. Kaynak", "2. Kaynak", "3. Kaynak", "4. Kaynak"] },
];

export function MatematikForm() {
